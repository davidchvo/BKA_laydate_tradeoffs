...
ICtab(clutch_m1p, clutch_m2p, clutch_m3p, dispersion = dfun(clutch_m1p), type = "qAICc", weights = TRUE)
```
...
# update models to x.quasipoisson where residuals are poisson AICs in a quasipossion model
